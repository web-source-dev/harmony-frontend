    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-100 to-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">Make a Difference</h1>
            ...
            <div className="flex items-center justify-center space-x-8 text-sm text-gray-600">
              <div className="flex items-center">
                <Shield className="h-5 w-5 text-gray-900 mr-2" />
                Secure Donation
              </div>
              <div className="flex items-center">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <Card className="shadow-2xl border-0 rounded-2xl overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-gray-900 to-gray-700 text-white text-center py-8">
                <CardTitle className="text-3xl font-bold mb-2">Support Our Mission</CardTitle>
              ...
              <CardContent className="p-8">
                {submitStatus === 'success' && (
                  <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                    <p className="text-green-800 font-medium">Thank you for your donation! Your contribution will help make music education accessible to all. You'll receive a confirmation email shortly.</p>
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                      {predefinedAmounts.map((amount) => (
                        ...
                        >
                          ${amount}
                          {donationType === "monthly" && <span className="text-sm block">/month</span>}
                        </button>
                      ))}
                    </div>

                    <div className="text-center">
                      <p className="text-gray-600 mb-3">Or enter a custom amount:</p>
                      <div className="max-w-xs mx-auto relative">
                        ...
                        <Input
                          ...
                          className="pl-10 text-center text-lg font-semibold rounded-lg"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Impact Display */}
                  <div className="mb-8 p-6 bg-gradient-to-br from-gray-100 to-gray-50 rounded-xl">
                    <h4 className="text-lg font-semibold text-gray-900 mb-3 text-center">Your Impact</h4>
                    {(() => {
                      ...
                      return <p className="text-center text-gray-600">Enter an amount to see your impact</p>
                    })()}
                  </div>

                  {/* Donor Information Form */}
                  <div className="space-y-6 mb-8">
                    <h4 className="text-lg font-semibold text-gray-900">Donor Information</h4>
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl mb-8">
                    <h4 className="text-lg font-semibold text-gray-900 mb-4">Donation Summary</h4>
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full relative overflow-hidden bg-gradient-to-r from-red-500 via-pink-500 to-purple-600 hover:from-red-600 hover:via-pink-600 hover:to-purple-700 text-white py-4 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-semibold group"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="text-center shadow-lg border-0 rounded-2xl hover:shadow-xl transition-all duration-300">
              <CardHeader>
                <div className="mx-auto w-16 h-16 bg-gradient-to-br from-gray-900 to-gray-700 rounded-2xl flex items-center justify-center mb-4">
                  <Gift className="h-8 w-8 text-white" />
                </div>
                <CardTitle className="text-xl font-bold text-gray-900">Instrument Donations</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="text-center shadow-lg border-0 rounded-2xl hover:shadow-xl transition-all duration-300">
              <CardHeader>
                ...
                <CardTitle className="text-xl font-bold text-gray-900">Planned Giving</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            <Card className="shadow-xl border-0 rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300">
              ...
              <CardContent className="p-6">
                <h3 className="text-lg font-bold text-gray-900 mb-2">Senator Addabbo Supports Our Mission</h3>
                ...
                <div className="flex items-center justify-between">
                  <Badge className="bg-gray-100 text-gray-700">July 2024</Badge>
                  <Badge className="bg-blue-100 text-blue-700">Community Support</Badge>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="text-center mt-12">
            <Link href="/media">
              <Button className="bg-black hover:bg-gray-800 text-white px-8 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                View All Media
              </Button>
            </Link>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-gray-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Every Dollar Makes a Difference</h2>
          <p className="text-xl mb-8 opacity-90">
            Join hundreds of donors who are helping us build a more inclusive and supportive community.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-black hover:bg-gray-800 text-white px-8 py-4 text-lg rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
