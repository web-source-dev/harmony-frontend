    ...
    <div className="min-h-screen bg-white">
          ...
          >
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">Equal Access</h3>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
              ...
              <div className="space-y-8">
                <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900">Inclusivity</h3>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900">Empowerment</h3>
            ...
            <div className="bg-black rounded-3xl p-12 text-white text-center shadow-2xl">
              <div className="max-w-4xl mx-auto">
                <h3 className="text-3xl font-bold mb-6">The Power of Music to Inspire, Unite, and Enrich</h3>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
              {storyMilestones.map((milestone, index) => (
                <div
                  key={index}
                  className={`flex items-start space-x-6 transition-all duration-1000 hover:scale-105 ${
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          {/* Team Stats */}
          <div
            className={`mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto transition-all duration-1000 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
