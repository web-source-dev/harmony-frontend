    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="text-center lg:text-left text-white">
              <h1 className="text-5xl md:text-7xl font-bold mb-6 drop-shadow-lg">Bianca Quddus</h1>
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>Juilliard Preparatory Division</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <Card className="shadow-lg border-0 rounded-2xl">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-700">Student at Bronx High School of Science</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Music className="h-5 w-5 text-black" />
                      <span className="text-gray-700">Clarinet student at Juilliard</span>
                    </div>
                    <div className="flex items-center space-x-3">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-700">Diverse Voices Scholar</span>
                    </div>
                  </CardContent>
                </Card>
      ...
      <section className="py-20 bg-black text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Support Bianca's Vision</h2>
