...
export default function JoshuaPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="relative">
              <div className="w-80 h-80 rounded-full overflow-hidden shadow-2xl border-8 border-white ring-4 ring-gray-100">
                <img
            ...
            <div className="text-center lg:text-left text-white">
              <h1 className="text-5xl md:text-7xl font-bold mb-6 drop-shadow-lg">Joshua Quddus</h1>
              <Badge className="bg-white text-black text-lg px-6 py-2 mb-6">
                Co-Founder
              </Badge>
              <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl drop-shadow-lg">
            ...
            <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <Card className="shadow-lg border-0 rounded-2xl">
                  <CardHeader>
                    <CardTitle className="text-3xl font-bold text-gray-900 flex items-center">
                      <BookOpen className="h-8 w-8 mr-4 text-black" />
                      Biography
                    </CardTitle>
                  </CardHeader>
                ...
                <Card className="shadow-lg border-0 rounded-2xl">
                  <CardHeader>
                    <CardTitle className="text-3xl font-bold text-gray-900 flex items-center">
                      <Trophy className="h-8 w-8 mr-4 text-black" />
                      Key Achievements
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-4">
                      {achievements.map((achievement, i) => (
                        <div key={i} className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                          <Star className="h-5 w-5 text-gray-600 mt-1 flex-shrink-0" />
                ...
                <Card className="shadow-lg border-0 rounded-2xl">
                  <CardHeader>
                    <CardTitle className="text-3xl font-bold text-gray-900 flex items-center">
                      <Mic className="h-8 w-8 mr-4 text-black" />
                      Performance Venues
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
              ...
              <div className="space-y-8">
                ...
                <Card className="shadow-lg border-0 rounded-2xl">
                  <CardHeader>
                    <CardTitle className="text-2xl font-bold text-gray-900">Quick Facts</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex items-center space-x-3">
                      <Calendar className="h-5 w-5 text-black" />
                      <span className="text-gray-700">Sophomore at Hunter College High School</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Music className="h-5 w-5 text-black" />
                      <span className="text-gray-700">Juilliard Graduate for Saxophone</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Globe className="h-5 w-5 text-black" />
                      <span className="text-gray-700">Global Youth Ambassador</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Calculator className="h-5 w-5 text-black" />
                      <span className="text-gray-700">Mathematics Enthusiast</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Users className="h-5 w-5 text-black" />
                      <span className="text-gray-700">Tutor through Relume Organization</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Code className="h-5 w-5 text-black" />
                      <span className="text-gray-700">Programmer & Educator</span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="shadow-lg border-0 rounded-2xl">
                  <CardHeader>
                    <CardTitle className="text-2xl font-bold text-gray-900">Connect</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
      ...
      <section className="py-20 bg-black text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Support Joshua's Vision</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/volunteer">
              <Button size="lg" variant="outline" className="border-2 border-white text-black hover:bg-white hover:text-black px-8 py-4 text-lg rounded-full">
                Volunteer With Us
              </Button>
            </Link>
          </div>
