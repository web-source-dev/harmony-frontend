      ...
      <section className="relative py-32 bg-cover bg-center bg-no-repeat" style={{
        ...
        <div className="container mx-auto px-4 relative z-10">
         <div className="flex flex-col items-center justify-center h-full">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 drop-shadow-lg">Get Involved</h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Ways to Make a Difference</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <Card className="shadow-xl border-0 rounded-2xl overflow-hidden group hover:shadow-2xl transition-all duration-300">
              <CardHeader className="text-center pb-4 bg-gray-50">
                <div className="mx-auto w-16 h-16 bg-black rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <Heart className="h-8 w-8 text-white" />
                </div>
                <CardTitle className="text-2xl font-bold text-gray-900">Donate</CardTitle>
              </CardHeader>
              <CardContent className="text-center p-6">
                ...
                <Link href="/donate">
                  <Button className="bg-black text-white hover:shadow-lg transition-all duration-300 rounded-full px-6 py-2 w-full">
                    Make a Donation
                  </Button>
                </Link>
              </CardContent>
            ...
            {donationLevels.map((level, index) => (
              ...
              >
                ...
                <CardHeader>
                  ...
                  <CardTitle className="text-3xl font-bold text-black">{level.amount}</CardTitle>
                </CardHeader>
                <CardContent>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {volunteerOpportunities.map((opportunity, index) => (
              <Card key={index} className="shadow-lg border-0 rounded-2xl overflow-hidden">
                ...
                <CardHeader>
                  <CardTitle className="text-xl font-bold text-gray-900">{opportunity.title}</CardTitle>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/donate">
              <Button
                size="lg"
                className="bg-black hover:bg-gray-800 text-white px-8 py-4 text-lg rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
                <Heart className="mr-2 h-5 w-5" />
                <span>Donate Today</span>
              </Button>
